...
--
-- Host: 127.0.0.1    Database: jp_dev
-- ------------------------------------------------------
...
CREATE TABLE `all_coupons` (
  ...
  KEY `fk_discount_type_idx` (`discount_type`),
...
CREATE TABLE `all_cuisines` (
  `cusine_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `all_dishes` (
  ...
  KEY `fk_dish_category_idx` (`dish_category`),
  KEY `fk_dish_type_idx` (`dish_type`),
  CONSTRAINT `all_dishes_cuisine_id_fkey` FOREIGN KEY (`cuisine_id`) REFERENCES `all_cuisines` (`cusine_id`),
  CONSTRAINT `fk_dish_category` FOREIGN KEY (`dish_category`) REFERENCES `dish_category_pl` (`dish_category`),
  CONSTRAINT `fk_dish_type` FOREIGN KEY (`dish_type`) REFERENCES `dish_type_pl` (`dish_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `all_payments` (
  ...
  KEY `fk_payment_status_idx` (`payment_status`),
  KEY `fk_payment_mode_idx` (`payment_mode`),
  KEY `fk_third_party_provider_idx` (`third_party_provider`),
  CONSTRAINT `all_payments_booking_id_fkey` FOREIGN KEY (`booking_id`) REFERENCES `booking_details` (`booking_id`),
  CONSTRAINT `fk_payment_mode` FOREIGN KEY (`payment_mode`) REFERENCES `payment_mode_pl` (`payment_mode`),
  CONSTRAINT `fk_payment_status` FOREIGN KEY (`payment_status`) REFERENCES `payment_status_pl` (`payment_status`),
  CONSTRAINT `fk_third_party_provider` FOREIGN KEY (`third_party_provider`) REFERENCES `third_party_provider_pl` (`third_party_provider`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bank_details` (
  `bank_record_key` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `booking_details` (
  ...
  KEY `fk_booking_status_idx` (`booking_status`),
  CONSTRAINT `booking_details_chef_id_fkey` FOREIGN KEY (`chef_id`) REFERENCES `chef_details` (`chef_id`),
  CONSTRAINT `fk_booking_status` FOREIGN KEY (`booking_status`) REFERENCES `booking_status_pl` (`booking_status`),
...
INSERT INTO `booking_details` VALUES (1,1,1,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'Vekhiya',_binary '\0\0\0\0\0\0\0€©ñ\”w1@s\ÀX~™ñS@',1,1,1,1,1,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:40:39','2019-08-17 09:40:39',0),(2,2,2,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'Vekhiya main',_binary '\0\0\0\0\0\0\0£ä,\„w1@kóS@',1,1,1,1,1,2,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:40:39','2019-08-17 09:40:39',0),(3,3,3,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'',_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',1,1,1,1,1,3,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:44:37','2019-08-17 09:44:37',0),(4,4,4,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'',_binary '\0\0\0\0\0\0\0\‰T\∆\Zâq1@é*çòóS@',1,1,1,1,1,4,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:44:37','2019-08-17 09:44:37',0),(5,5,5,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'',_binary '\0\0\0\0\0\0\0€©ñ\”w1@s\ÀX~™ñS@',1,1,1,1,1,5,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:44:37','2019-08-17 09:44:37',0),(6,6,6,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'',_binary '\0\0\0\0\0\0\0£ä,\„w1@kóS@',1,1,1,1,1,6,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:44:37','2019-08-17 09:44:37',0),(7,7,7,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'',_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',1,1,1,1,1,7,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:44:37','2019-08-17 09:44:37',0),(8,8,8,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'',_binary '\0\0\0\0\0\0\0\‰T\∆\Zâq1@é*çòóS@',1,1,1,1,1,8,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:27','2019-08-17 09:44:37','2019-08-17 09:44:37',0),(9,9,9,'2019-08-05 12:49:03','2019-08-05 14:19:03',350.00,50.00,50.00,50.00,50.00,50.00,50.00,50.00,'',NULL,1,1,1,1,1,9,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-07-30 21:20:28','2019-08-17 09:34:24','2019-08-17 09:34:24',0);
...
CREATE TABLE `booking_extra_details` (
  `booking_extra_detail_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `booking_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `booking_status_pl`
--

DROP TABLE IF EXISTS `booking_status_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `booking_status_pl` (
  `booking_status` int(11) NOT NULL AUTO_INCREMENT,
  `booking_status_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `booking_status_pl`
--

LOCK TABLES `booking_status_pl` WRITE;
/*!40000 ALTER TABLE `booking_status_pl` DISABLE KEYS */;
INSERT INTO `booking_status_pl` VALUES (1,'Inactive',NULL,NULL,'2019-08-03 14:04:24','2019-08-03 14:04:24','2019-08-03 14:04:24',0),(2,'Started',NULL,NULL,'2019-08-03 14:04:24','2019-08-03 14:04:24','2019-08-03 14:04:24',0),(3,'In Progress',NULL,NULL,'2019-08-03 14:04:24','2019-08-03 14:04:24','2019-08-03 14:04:24',0),(4,'Completed',NULL,NULL,'2019-08-03 14:04:24','2019-08-03 14:04:24','2019-08-03 14:04:24',0),(5,'Cancelled',NULL,NULL,'2019-08-03 14:04:24','2019-08-03 14:04:24','2019-08-03 14:04:24',0);
/*!40000 ALTER TABLE `booking_status_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `category_tariff` (
  `category_tariff_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `chef_category_pl`
--

DROP TABLE IF EXISTS `chef_category_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `chef_category_pl` (
  `chef_category` int(11) NOT NULL AUTO_INCREMENT,
  `chef_category_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`chef_category`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `chef_category_pl`
--

LOCK TABLES `chef_category_pl` WRITE;
/*!40000 ALTER TABLE `chef_category_pl` DISABLE KEYS */;
INSERT INTO `chef_category_pl` VALUES (1,'A',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'B+',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(3,'B',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(4,'C+',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(5,'C',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `chef_category_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `chef_commissions` (
  `comm_mapping_key` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
  `base_cost` decimal(16,2) DEFAULT NULL,
...
CREATE TABLE `chef_details` (
  ...
  `chef_image` varchar(500) DEFAULT NULL,
  ...
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`chef_id`),
  KEY `fk_categary_idx` (`chef_category`),
  KEY `fk_chef_type_idx` (`chef_type`),
  CONSTRAINT `fk_categary` FOREIGN KEY (`chef_category`) REFERENCES `chef_category_pl` (`chef_category`),
  CONSTRAINT `fk_chef_type` FOREIGN KEY (`chef_type`) REFERENCES `chef_type_pl` (`chef_type`)
...
INSERT INTO `chef_details` VALUES (1,'VR1',1,'Graduate','Mexican','Good Communicator',1,_binary '\0\0\0\0\0\0\0£ä,\„w1@kóS@',NULL,7321423451,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(2,'VR2',1,'Graduate2','Indian','Good Communicator',1,_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',NULL,7321423452,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(3,'VR3',1,'Graduate3','South Indian','Good Communicator',1,_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',NULL,7321423453,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(4,'VR4',1,'Graduate4','Continental','Good Communicator',1,_binary '\0\0\0\0\0\0\0\‰T\∆\Zâq1@é*çòóS@',NULL,7321423454,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(5,'VR5',1,'Graduate5','Chinese','Good Communicator',1,_binary '\0\0\0\0\0\0\0€©ñ\”w1@s\ÀX~™ñS@',NULL,7321423455,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(6,'VR6',1,'Graduate11','Mexican','Good Communicator',1,_binary '\0\0\0\0\0\0\0£ä,\„w1@kóS@',NULL,7321423456,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(7,'VR7',1,'Graduate12','Afghani','Good Communicator',1,_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',NULL,7321423457,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(8,'VR8',1,'Graduate13','Italian','Good Communicator',1,_binary '\0\0\0\0\0\0\0\‰T\∆\Zâq1@é*çòóS@',NULL,7321423458,0,'User',NULL,'2019-07-30 20:19:18','2019-08-17 10:20:28','2019-08-17 10:20:28',0),(9,'VR9',1,'Graduate21','Pizza','Good Communicator',1,_binary '\0\0\0\0\0\0\0¢]ÖîüÄE¿•iP4ûE@',NULL,7321423459,0,'User',NULL,'2019-07-30 20:19:18','2019-07-30 20:19:18','2019-07-30 20:19:18',0),(10,'VR10',1,'HSC','Mexican','Good Communicator',1,_binary '\0\0\0\0\0\0\0¢]ÖîüÄE¿•iP4ûE@',NULL,7321423450,0,'User',NULL,'2019-07-30 20:19:18','2019-07-30 20:19:18','2019-07-30 20:19:18',0),(11,'VR11',1,'Graduate','Mexican','Good Communicator',1,_binary '\0\0\0\0\0\0\0¢]ÖîüÄE¿•iP4ûE@',NULL,7321423451,0,'User',NULL,'2019-07-30 20:19:18','2019-07-30 20:19:18','2019-07-30 20:19:18',0);
...
CREATE TABLE `chef_dish_mappings` (
  `dish_mapping_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
  `dish_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `chef_earnings` (
  `chef_earnings_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
  `booking_id` bigint(20) DEFAULT NULL,
  ...
  KEY `fk_offset_reason_idx` (`offset_reason`),
  ...
  CONSTRAINT `fk_offset_reason` FOREIGN KEY (`offset_reason`) REFERENCES `offset_reason_pl` (`offset_reason`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chef_earnings_payouts_total` (
  `chef_earnings_payout_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `chef_extra_details` (
  `chef_extra_detail_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
  ...
  KEY `fk_verification_status_idx` (`verification_status`),
...
CREATE TABLE `chef_languages` (
  `chef_language_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `chef_login_details` (
  `chef_login_details_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `chef_payouts` (
  `chef_payout_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
  ...
  KEY `chef_transfer_mode_idx` (`transfer_mode`),
  CONSTRAINT `chef_payouts_chef_id_fkey` FOREIGN KEY (`chef_id`) REFERENCES `chef_details` (`chef_id`),
  CONSTRAINT `chef_transfer_mode` FOREIGN KEY (`transfer_mode`) REFERENCES `transfer_mode_pl` (`transfer_mode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `chef_type_pl`
--

DROP TABLE IF EXISTS `chef_type_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `chef_type_pl` (
  `chef_type` int(11) NOT NULL AUTO_INCREMENT,
  `chef_type_description` varchar(20) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`chef_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `chef_type_pl`
--

LOCK TABLES `chef_type_pl` WRITE;
/*!40000 ALTER TABLE `chef_type_pl` DISABLE KEYS */;
INSERT INTO `chef_type_pl` VALUES (1,'Vegetarian',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'Non-Vegetarian',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `chef_type_pl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `coupon_status_pl`
--

DROP TABLE IF EXISTS `coupon_status_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `coupon_status_pl` (
  `Coupon_Status` int(11) NOT NULL AUTO_INCREMENT,
  `Coupon_Status_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`Coupon_Status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `coupon_status_pl`
--

LOCK TABLES `coupon_status_pl` WRITE;
/*!40000 ALTER TABLE `coupon_status_pl` DISABLE KEYS */;
/*!40000 ALTER TABLE `coupon_status_pl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `discount_type_pl`
--

DROP TABLE IF EXISTS `discount_type_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `discount_type_pl` (
  `discount_type` int(11) NOT NULL AUTO_INCREMENT,
  `discount_type_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `discount_type_pl`
--

LOCK TABLES `discount_type_pl` WRITE;
/*!40000 ALTER TABLE `discount_type_pl` DISABLE KEYS */;
/*!40000 ALTER TABLE `discount_type_pl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dish_category_pl`
--

DROP TABLE IF EXISTS `dish_category_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dish_category_pl` (
  `dish_category` int(11) NOT NULL AUTO_INCREMENT,
  `dish_category_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`dish_category`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dish_category_pl`
--

LOCK TABLES `dish_category_pl` WRITE;
/*!40000 ALTER TABLE `dish_category_pl` DISABLE KEYS */;
INSERT INTO `dish_category_pl` VALUES (1,'Starter',NULL,NULL,'2019-08-03 14:37:19','2019-08-03 14:37:19','2019-08-03 14:37:19',0),(2,'Main Course',NULL,NULL,'2019-08-03 14:37:19','2019-08-03 14:37:19','2019-08-03 14:37:19',0),(3,'Accompaniments',NULL,NULL,'2019-08-03 14:37:19','2019-08-03 14:37:19','2019-08-03 14:37:19',0),(4,'Dessert',NULL,NULL,'2019-08-03 14:37:19','2019-08-03 14:37:19','2019-08-03 14:37:19',0);
/*!40000 ALTER TABLE `dish_category_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `dish_ingredient_mapping` (
  `ingredient_mapping_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `dish_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `dish_type_pl`
--

DROP TABLE IF EXISTS `dish_type_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dish_type_pl` (
  `dish_type` int(11) NOT NULL AUTO_INCREMENT,
  `dish_type_description` varchar(20) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`dish_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dish_type_pl`
--

LOCK TABLES `dish_type_pl` WRITE;
/*!40000 ALTER TABLE `dish_type_pl` DISABLE KEYS */;
INSERT INTO `dish_type_pl` VALUES (1,'Vegetarian',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'Non Vegetarian',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `dish_type_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `general_chef_ratings` (
  `general_ratings_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `chef_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `ingredient_appliance_mappings` (
  `app_mapping_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ingredient_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `login_mode_pl`
--

DROP TABLE IF EXISTS `login_mode_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `login_mode_pl` (
  `login_mode` char(1) NOT NULL,
  `login_mode_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`login_mode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `login_mode_pl`
--

LOCK TABLES `login_mode_pl` WRITE;
/*!40000 ALTER TABLE `login_mode_pl` DISABLE KEYS */;
INSERT INTO `login_mode_pl` VALUES ('G','Google',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),('P','Phone',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `login_mode_pl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `offset_reason_pl`
--

DROP TABLE IF EXISTS `offset_reason_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `offset_reason_pl` (
  `offset_reason` int(11) NOT NULL AUTO_INCREMENT,
  `offset_reason_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`offset_reason`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `offset_reason_pl`
--

LOCK TABLES `offset_reason_pl` WRITE;
/*!40000 ALTER TABLE `offset_reason_pl` DISABLE KEYS */;
INSERT INTO `offset_reason_pl` VALUES (1,'Cancelled',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'Delay',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(3,'Feedback',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(4,'Etiquette',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `offset_reason_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `payment_breakdown` (
  `payment_breakdown_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `payment_mode_pl`
--

DROP TABLE IF EXISTS `payment_mode_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `payment_mode_pl` (
  `payment_mode` int(11) NOT NULL AUTO_INCREMENT,
  `payment_mode_description` varchar(20) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `payment_mode_pl`
--

LOCK TABLES `payment_mode_pl` WRITE;
/*!40000 ALTER TABLE `payment_mode_pl` DISABLE KEYS */;
INSERT INTO `payment_mode_pl` VALUES (1,'Cash',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'Wallet',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(3,'Internet Banking',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(4,'Debit/credit Card',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `payment_mode_pl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `payment_status_pl`
--

DROP TABLE IF EXISTS `payment_status_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `payment_status_pl` (
  `payment_status` int(11) NOT NULL AUTO_INCREMENT,
  `payment_status_description` varchar(20) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `payment_status_pl`
--

LOCK TABLES `payment_status_pl` WRITE;
/*!40000 ALTER TABLE `payment_status_pl` DISABLE KEYS */;
INSERT INTO `payment_status_pl` VALUES (1,'Initiated',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'In progress',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(3,'Pending',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(4,'Completed',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(5,'Failed',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `payment_status_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `special_appliances` (
  `sp_app_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `third_party_provider_pl`
--

DROP TABLE IF EXISTS `third_party_provider_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `third_party_provider_pl` (
  `third_party_provider` int(11) NOT NULL AUTO_INCREMENT,
  `third_party_provider_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`third_party_provider`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `third_party_provider_pl`
--

LOCK TABLES `third_party_provider_pl` WRITE;
/*!40000 ALTER TABLE `third_party_provider_pl` DISABLE KEYS */;
INSERT INTO `third_party_provider_pl` VALUES (1,'Paytm',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'Google Pay',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(3,'Amazon Pay',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(4,'Lazy Pay',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(5,'PhonePe',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(6,'Mobikwik',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(7,'Freecharge',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `third_party_provider_pl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `transfer_mode_pl`
--

DROP TABLE IF EXISTS `transfer_mode_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `transfer_mode_pl` (
  `transfer_mode` int(11) NOT NULL AUTO_INCREMENT,
  `transfer_mode_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`transfer_mode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `transfer_mode_pl`
--

LOCK TABLES `transfer_mode_pl` WRITE;
/*!40000 ALTER TABLE `transfer_mode_pl` DISABLE KEYS */;
INSERT INTO `transfer_mode_pl` VALUES (1,'Wallet Payout',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(2,'Bank Transfer',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(3,'Wallet Transfer',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `transfer_mode_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `used_coupons` (
  `used_coupon_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) DEFAULT NULL,
  `booking_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `user_group_mappings` (
  `user_group_mapping_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_group_id` bigint(20) DEFAULT NULL,
  `user_id` bigint(20) DEFAULT NULL,
...
INSERT INTO `user_groups` VALUES (1,'Regular',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(2,'Seldom',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(3,'Occasional',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(4,'Active',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(5,'Dormant',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(6,'Deactive',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(7,'Frequent',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(8,'AB1',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0),(9,'XY2',0,NULL,NULL,NULL,NULL,'2019-07-30 20:51:03','2019-07-30 20:51:03','2019-07-30 20:51:03',0);
...
CREATE TABLE `user_saved_addresses` (
  `saved_address_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) DEFAULT NULL,
...
INSERT INTO `user_saved_addresses` VALUES (1,1,'Anda','301 flat sri vinayaka','301 flat sri vinayaka','301 flat sri vinayaka',_binary '\0\0\0\0\0\0\0£ä,\„w1@kóS@',NULL,NULL,'2019-07-30 20:42:29','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(2,2,'Banda','301 flat sri vinayaka','301 flat sri vinayaka','301 flat sri vinayaka',_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(3,3,'CH1BR2','502, SVSS1','Kondapur','Hyderabad',_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(4,4,'CH1BR3','502, SVSS2','Kondapur','Hyderabad',_binary '\0\0\0\0\0\0\0\‰T\∆\Zâq1@é*çòóS@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(5,5,'CH1BR4','502, SVSS3','Kondapur','Hyderabad',_binary '\0\0\0\0\0\0\0€©ñ\”w1@s\ÀX~™ñS@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(6,6,'CH1BR5','502, SVSS4','Kondapur','Hyderabad',_binary '\0\0\0\0\0\0\0£ä,\„w1@kóS@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(7,7,'CH1BR6','502, SVSS5','Kondapur','Hyderabad',_binary '\0\0\0\0\0\0\0\ﬁhõ\Ÿx1@Ø\∆IÜïS@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(8,8,'CH1BR7','502, SVSS6','Kondapur','Hyderabad',_binary '\0\0\0\0\0\0\0\‰T\∆\Zâq1@é*çòóS@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0),(9,9,'CH1BR8','502, SVSS7','Kondapur','Hyderabad',_binary '\0\0\0\0\0\0\0¢]ÖîüÄE¿•iP4ûE@',NULL,NULL,'2019-07-30 20:43:41','2019-08-17 09:55:48','2019-08-17 09:55:48',0);
/*!40000 ALTER TABLE `user_saved_addresses` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `verification_status_pl`
--

DROP TABLE IF EXISTS `verification_status_pl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `verification_status_pl` (
  `verification_status` int(11) NOT NULL,
  `verification_status_description` varchar(50) DEFAULT NULL,
  `createdby` varchar(50) DEFAULT NULL,
  `modifiedby` varchar(50) DEFAULT NULL,
  `createdts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `lastmodifiedts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `synctimestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `softdeleteflag` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`verification_status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `verification_status_pl`
--

LOCK TABLES `verification_status_pl` WRITE;
/*!40000 ALTER TABLE `verification_status_pl` DISABLE KEYS */;
INSERT INTO `verification_status_pl` VALUES (0,'Not Verified',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0),(1,'Verified',NULL,NULL,'2019-08-03 14:06:33','2019-08-03 14:06:33','2019-08-03 14:06:33',0);
/*!40000 ALTER TABLE `verification_status_pl` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-08-17 15:55:22
